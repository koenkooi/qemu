...
static const hwaddr am335x_prcm_clkctrl_offsets[] = {
    /* CM_PER (base 0x000) */
    0x014, 0x018, 0x024, 0x028, 0x02C, 0x030, 0x034, 0x03C, 0x040, 0x044,
    0x048, 0x04C, 0x050, 0x060, 0x068, 0x06C, 0x07C, 0x080, 0x084, 0x088,
    0x0AC, 0x0B0, 0x0B4, 0x0BC, 0x0C0, 0x0C4, 0x0CC, 0x0D4, 0x0D8, 0x0DC,
    0x0E0, 0x0E4, 0x0E8, 0x0EC, 0x0F0, 0x0F4, 0x0F8, 0x0FC, 0x100, 0x10C,
    0x110, 0x120, 0x130, 0x14C,
    /* CM_WKUP (base 0x400) */
